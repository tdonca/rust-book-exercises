...
fn test_parse_pair() {
    ...
    assert_eq!(parse_pair::<i32>("10,a", ','), None);
    assert_eq!(parse_pair::<f32>("0.5,8", ','), Some((0.5,8.0)));
}
...
fn main() {
    ...
    if args.len() != 5 {
        ...
        eprintln!("Example: {} mandel.png 1000x750 -120,0.35 -1,0.20", args[0]);
        std::process::exit(1);
    }
    ...
    // Converted to concurrent processing:
    let threads = 8;
